...
const FOOTER_LINKS = {
  learn: {
    ...
    links: [
      ...
      { label: "Examples", href: "https://github.com/zirco-lang/zrc/tree/main/examples" },
    ]
  },
  community: {
    title: "Community",
  ...
  resources: {
    ...
    links: [
      ...
      { label: "Contributing", href: "https://github.com/zirco-lang/zrc/pulls" },
    ...
    <footer className="border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 text-sm">
              A general-purpose programming language for robust, optimal, and clear software.
            </p>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-700 text-sm text-gray-600 dark:text-gray-400 transition-colors duration-300">
          <p>© {currentYear} Zirco Contributors and dawn_ll. Released under the MIT License.</p>
        </div>
      </div>
    </footer>
  );
