  ...
  const features = [
    {
      ...
      description: "Zirco features an extremely strong runtime type system that catches errors early and provides robust guarantees about your program's behavior."
    },
    {
      icon: Code,
      title: "Modern Syntax",
      description: "Combines the familiarity of C with Rust-inspired modern language design. Clean, expressive syntax that's both readable and powerful."
    },
    {
      icon: Cpu,
      title: "Native Performance",
      description: "Compiles to native code via LLVM. Suitable for low-level systems programming tasks where performance and control matter most."
    },
    {
      icon: Wrench,
      title: "Systems Programming Ready",
      description: "Designed for systems-level development with C-like semantics, providing the control you need for embedded, kernel, and performance-critical applications."
    }
  ];

  return (
    <section id="features" className="min-h-screen pt-16 md:pt-20 flex items-center max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
